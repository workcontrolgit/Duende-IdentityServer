...
using DuendeIdentityServer.STS.Identity.Configuration.ApplicationParts;
...
using DuendeIdentityServer.STS.Identity.Helpers.Localization;
using DuendeIdentityServer.STS.Identity.Services;

namespace DuendeIdentityServer.STS.Identity.Helpers
{
